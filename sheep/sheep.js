export class Sheep {
  ...
  draw(ctx, t, dots) {
    ...
    // console.log('sheep draw ctx: ', ctx)
  }

  animate(ctx, dots) {
    // console.log('sheep animate')
    ...
    // console.log('-this.sheepWidthHalf, -this.sheepHeight + 20, this.sheepWidth, this.sheepHeight : ', -this.sheepWidthHalf, -this.sheepHeight + 20, this.sheepWidth, this.sheepHeight)
  }
